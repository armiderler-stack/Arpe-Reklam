-- Once calisan politikalari temizle (guvenli tekrar calistirma icin)
...
drop policy if exists "Herkes aktif işletmeyi slug ile görebilir (public sayfa için)" on public.businesses;
drop policy if exists "Kullanıcı kendi işletmesini oluşturabilir" on public.businesses;
drop policy if exists "Kullanıcı kendi işletmesini güncelleyebilir" on public.businesses;
drop policy if exists "Kullanıcı kendi işletmesini silebilir" on public.businesses;
drop policy if exists "Herkes aktif işletmenin görünür linklerini görebilir" on public.links;
drop policy if exists "Sahip kendi işletmesinin linklerini yönetebilir (insert)" on public.links;
drop policy if exists "Sahip kendi işletmesinin linklerini yönetebilir (update)" on public.links;
drop policy if exists "Sahip kendi işletmesinin linklerini yönetebilir (delete)" on public.links;
drop policy if exists "Herkes aktif işletmenin menüsünü görebilir" on public.menus;
drop policy if exists "Sahip kendi menüsünü yönetebilir (insert)" on public.menus;
drop policy if exists "Sahip kendi menüsünü yönetebilir (update)" on public.menus;
drop policy if exists "Sahip kendi menüsünü yönetebilir (delete)" on public.menus;
drop policy if exists "Herkes menu PDF dosyalarını okuyabilir" on storage.objects;
drop policy if exists "Giriş yapan kullanıcı PDF yükleyebilir" on storage.objects;
drop policy if exists "Giriş yapan kullanıcı kendi PDF sini güncelleyebilir" on storage.objects;
drop policy if exists "Giriş yapan kullanıcı kendi PDF sini silebilir" on storage.objects;
drop policy if exists "Herkes logoları okuyabilir" on storage.objects;
drop policy if exists "Giriş yapan kullanıcı logo yükleyebilir" on storage.objects;
drop policy if exists "Giriş yapan kullanıcı logo güncelleyebilir" on storage.objects;
